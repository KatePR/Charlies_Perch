...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel6" runat="server" BackColor="#CC0000" Height="19px" style="margin-top: 0px">
            <asp:Panel ID="Panel5" runat="server" BackColor="#202020" Height="429px" Width="153px">
                ...
                <asp:Button ID="assignButton" runat="server" Height="40px" OnClick="assignButton_Click" style="margin-left: 13px; margin-top: 24px" Text="Assign Staff" Width="124px" />
                <asp:Button ID="reportButton" runat="server" Height="40px" OnClick="reportButton_Click" style="margin-left: 13px; margin-top: 24px" Text="Report" Width="124px" />
                <br />
                <br />
                <br />
                <br />
