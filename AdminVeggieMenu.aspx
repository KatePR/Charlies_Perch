<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminVeggieMenu.aspx.cs" Inherits="AdminVeggieMenu" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="margin-left: 217px" Text="Add" Width="76px" />
